...
import { chatSuggestions } from "@/config/chat-prompt";
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-sm font-semibold">
              {USER.firstName + " " + USER.lastName}&apos;s Portfolio Assistant
            </h3>
                ...
                <div className="flex flex-wrap gap-2 px-3">
                  {chatSuggestions.map((suggestion, index) => (
                    <Button
                      ...
                      className="h-8 border-muted-foreground/20 bg-background px-3 text-xs hover:bg-muted"
                    >
                      {suggestion}
                    </Button>
                  ))}
