  ...
  return (
    ...
    >
      <div
        ref={chatRef}
        className={cn(
          "fixed inset-0 flex h-full w-full flex-col overflow-hidden border bg-background shadow-md transition-all duration-250 ease-out sm:absolute sm:inset-auto sm:h-[80vh] sm:w-[90vw] sm:rounded-lg",
